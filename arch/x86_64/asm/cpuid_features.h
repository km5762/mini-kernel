enum {
    CPUID_FEATURE_EBX_BRAND_INDEX        = 0xFF << 0,
    CPUID_FEATURE_EBX_CLFLUSH_LINE_SIZE  = 0xFF << 8,
    CPUID_FEATURE_EBX_APIC_ID_SPACE      = 0xFF << 16,
    CPUID_FEATURE_EBX_INITIAL_APIC_ID    = 0xFF << 24,
